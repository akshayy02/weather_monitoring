...
export default function HistoricalData() {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-light-800">Historical Weather Data</h2>
      <div className="flex space-x-4">
        <select
          value={selectedCity}
          onChange={(e) => setSelectedCity(e.target.value)}
          className="block w-full mt-1 text-black rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
        >
